...
REQUIRED_FILES = [
    ...
    "scripts/preflight_local_profiling.py",
...
REQUIRED_TEXT = {
    ...
    "scripts/stage-gff-assets.sh": [
        "Stage reference FASTA and GFF3 assets",
        "--reference URI_OR_FILE",
        "--annotation URI_OR_FILE",
        "--reference-sha256 HEX",
        "--annotation-sha256 HEX",
        "curl --fail --location --continue-at -",
        "gff-asset-checksums.json",
        "reference_fasta",
        "annotation_gff3",
    ...
    "TODO.md": [
        ...
        "Stage approved reference FASTA and GFF3 assets",
    ...
    "docs/release-readiness.rst": [
        "Release Readiness",
        "Current GB10 Access",
        "stephen@192.168.1.48",
        "/Users/stephen/.ssh/dgx_spark.pem",
        "/home/stephen/gb10-verification-20260704/",
        "Minimum Local Checks",
        "scripts/stage-gff-assets.sh --reference",
